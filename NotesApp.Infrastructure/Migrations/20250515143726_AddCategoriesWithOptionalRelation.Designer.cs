...
namespace NotesApp.Infrastructure.Migrations
{
    ...
    [Migration("20250515143726_AddCategoriesWithOptionalRelation")]
    partial class AddCategoriesWithOptionalRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotesApp.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("NotesApp.Domain.Entities.Note", b =>
                {
                    b.HasOne("NotesApp.Domain.Entities.Category", "Category")
                        .WithMany("Notes")
